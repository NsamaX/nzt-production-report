<h1 align="center">NZT Production Management</h1>

## Overview

Welcome to NZT Production Management, a web application designed to manage and report on production line operations for Nozomi Company (NZT). It provides comprehensive functionalities to monitor, analyze, and report manufacturing output, with features tailored to different user roles.
